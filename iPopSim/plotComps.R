...
plotComps <- function(dat1,dat2,datN, saveloc = NA){
  ...
  if(is.na(saveloc)){
    ...
    ggsave(last_plot(), file = paste0(out_file,"/",paste0(fLevs[l,'DESC'],"_ageComps.jpg")), dpi = 480, height = 10, width = 8, unit = 'in')
  }
  ...
  if(is.na(saveloc)){
    ...
    ggsave(last_plot(), file = paste0(out_file,"/",paste0(fLevs[l,'DESC'],"_lenComps.jpg")), dpi = 480, height = 10, width = 8, unit = 'in')
  }  
