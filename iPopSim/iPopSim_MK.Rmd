...
Now read in the stitched dataframe, which contains a subsample of fish from each year under a given regime, and fake the lat data.
```{r stich fake sets, echo = T}
for(l in 1:nrow(fLevs)){
 
  ## get output files for this Ftrend
  ID <- paste(fLevs[l,1],fLevs[l,2])
