...
# SS3 growth model (vonBert with L1&L2, SS3 3.24f mannual, Page 42)
L1 = 62.69
L2 = 216.72
a1 = 0
a2 = 15
...
## Effort Simulator ORIGINAL ----
generate.effortOG = function(level,nsim) {
...
maketables = function(path_name){
  SAA = data.frame(cohort=c(-999),uni_ind = c(-999),ind =c(-999),
                   ...
                   FMORT=c(-999),M=c(-999),Sel=c(-999), FSIM = c(-999))
...
## plot agecomps from simulated data -- made to mimic SS_plotcomps
## for use on simulated datasets EXTERNAL to SS3SIM
