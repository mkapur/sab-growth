...
# MuMIn::model.sel(mod,mod1,mod2,mod3) ## support for 2-year lag, not 3
...
ypreds <- read.csv( paste0(getwd(),"/results/predicts2018-12-11.csv"))
## plotting ----
...
ggplot(ypreds, aes(x = Age, y = Predicted, col = Sex )) +
  ...
  facet_wrap(~REG)
ggsave(file = paste0(getwd(),"/plots/fits_gam.png"), 
