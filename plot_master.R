...
levels(scens.title) <-  c("g) Scenario 2 Break at 25 deg.", "g) Scenario 4 Break at 49 deg.", 
                          "g) Scenario 3 Overlap 20-25 deg.","g) Scenario 1 No Breaks",
                          "g) Scenario 5 Temporal Break Year 50")
levels(scens.title0) <-  c("b) Scenario 2 Break at 25 deg.", "d) Scenario 4 Break at 49 deg.", 
