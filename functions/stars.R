#http://esapubs.org/archive/ecol/E095/262/STARS.R
...
stars<- function(y=c(rnorm(50), age = rnorm(50,2,1)), L=20, p=0.05, h=1,  AR1red="none", prewhitening = F) {
...
starsOb <- stars()
plot.stars(starsOb,age1 = rnorm(50,2,1))
