...
load("C:/Users/mkapur/Dropbox/UW/sab-growth/data/vast_data.rda")


all_data <-
  all_data %>% mutate(SPECIES_CODE = 20510,
                      GEAR_DEPTH = NA,
                      Temp = NA,
                      GEAR_TEMPERATURE = NA) %>%
  plyr::rename(
...
save(sab, file = "C:/Users/mkapur/Dropbox/UW/sab-growth/spatiotemporalBSAIgrowth-master/VAST_output/corrected_sab.rda")
run_one_spp(sab, 
